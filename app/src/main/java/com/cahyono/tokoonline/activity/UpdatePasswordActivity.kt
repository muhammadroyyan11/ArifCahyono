...
class UpdatePasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_updatePassword.setOnClickListener(object: View.OnClickListener {
...
//    3. post
    ...
    fun updated(){
        ...
        ApiConfig.instanceRetrofit.updatePassword(user.email, password.text.toString()).enqueue(object : Callback<ResponModel> {
            override fun onResponse(call: Call<ResponModel>, response: Response<ResponModel>) {
                ...
                if (respon.success == 1){
                    ...
                    Toast.makeText(applicationContext, "Berhasil merubah password", Toast.LENGTH_SHORT).show()
